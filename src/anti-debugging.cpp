...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR args, int ncmdshow)
{
	...
	HWND hwnd = CreateWindowA("MainWindowClass", "Guided Hacking AntiDebug Bypass Tool", (WS_OVERLAPPEDWINDOW | WS_VISIBLE) & ~(WS_MAXIMIZEBOX), 100, 100, 538, 330, NULL, NULL, NULL, NULL);
	SetIcon(hwnd);
